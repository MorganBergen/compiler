...
std::string keyword[] = { "POLY", "INPUT", "TASKS", "EXECUTE", "OUTPUT", "INPUTS" };
...
//  internal vector.  this facilates the implementation of peek()
...
//  GetToken() accesses tokens from the tokenList that is populated
//  when a lexer object is instantiated
